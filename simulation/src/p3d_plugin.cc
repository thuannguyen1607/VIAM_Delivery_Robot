  ...
  if (this->pub_.getNumSubscribers() > 0)
  {
    ...
    if (tmp_dt != 0)
    {
      ...
      if (this->topic_name_ != "")
      {
        ...
        // apply xyz and rpy offsets and get position and rotation components
        ...
        this->pose_msg_.pose.pose.position.z    = 0;
